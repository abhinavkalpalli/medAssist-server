  ...
  async editDoctor(userData: Partial<Doctor>): Promise<Doctor | null> {
    try {
      ...
      if (data) {
        ...
        data.workingHospitalContact =
          userData.workingHospitalContact ?? data.workingHospitalContact;
        data.experienceYears = userData.experienceYears
          ? Number(userData.experienceYears)
          : data.experienceYears;
        data.dateOfBirth = userData.dateOfBirth ?? data.dateOfBirth;
        data.gender = userData.gender ?? data.gender;
        data.currentWorkingHospital =
          userData.currentWorkingHospital ?? data.currentWorkingHospital;
