...
router.post('/create-payment',PatientController.createPayment.bind(PatientController))
router.post('/verify-payment',PatientController.verifyPayment.bind(PatientController))
