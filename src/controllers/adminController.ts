...
export default class adminController implements IadminController{
    ...
    async updateFee(req: Request, res: Response, next: NextFunction) {
        try{
            ...
            const data=await this._adminService.updateFee(parseFloat(baseFee as string), parseFloat(Increment as string),email)
    ...
    async editExpertise(req: Request, res: Response, next: NextFunction) {
        try {
            ...
            const data=await this._adminService.editExpertise(id as string,name as string)
            if(data){
